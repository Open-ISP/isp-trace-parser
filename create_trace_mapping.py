...
#
# duids_and_station_names = static_table('Generators and Scheduled Loads', "D:/nemosis_data_cache",
#                                        select_columns=['Station Name', 'DUID', 'Fuel Source - Primary'],
#                                        update_static_file=True)
# wind_duids_and_station_names = duids_and_station_names[duids_and_station_names['Fuel Source - Primary'] == 'Wind']
# wind_duids_and_station_names = wind_duids_and_station_names.drop(columns=['Fuel Source - Primary'])
...
# wind_generator_mapping = draft_wind_generator_to_trace_mapping(wind_gens, wind_duids_and_station_names, wind_traces)

...
with Path("draft_solar_generator_mapping.yaml").open("w") as file:
...
with Path("solar_area_mapping.yaml").open("w") as file:
...
with Path("draft_wind_generator_mapping.yaml").open("w") as file:
...
with Path("draft_wind_rez_mapping.yaml").open("w") as file:
